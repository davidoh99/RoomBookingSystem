...
public class FullDemo {
     ...
     *
     * @param rowMarker the row marker
     ...
     *
     * @param e the new time one with time two button clicked
     */
     ...
     *
     * @param e the new two with Y 2 K button clicked
     */
     ...
     *
     * @param e the new one with two button clicked
     */
     ...
     *
     * @param e the new one with feb 31 button clicked
     */
     ...
     *
     * @param e the e
     * @return the one and show button clicked
     */
     ...
     * picker one.
     *
     * @return the date picker one date text
     */
    ...
    private static class SampleDateChangeListener implements DateChangeListener {
         ...
         * Constructor.
         *
         * @param datePickerName the date picker name
         */
    ...
    private static class SampleDateTimeChangeListener implements DateTimeChangeListener {
         ...
         * Constructor.
         *
         * @param dateTimePickerName the date time picker name
         */
    ...
    private static class SampleDateVetoPolicy implements DateVetoPolicy {
         ...
         *
         * @param date the date
         * @return true, if is date allowed
         */
        @Override
    ...
    private static class SampleHighlightPolicy implements DateHighlightPolicy {
         ...
         *
         * @param date the date
         * @return the highlight information or null
         */
        @Override
    ...
    private static class SampleTimeChangeListener implements TimeChangeListener {
         ...
         * Constructor.
         *
         * @param timePickerName the time picker name
         */
