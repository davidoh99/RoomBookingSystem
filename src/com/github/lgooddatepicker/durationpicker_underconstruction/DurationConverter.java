...
public class DurationConverter {
    ...
    /**
     * Gets the used duration unit set.
     *
     * @param smallestUnit the smallest unit
     * @param largestUnit the largest unit
     * @return the used duration unit set
     */
